-- mysqldump --user=root -p --add-drop-database --complete-insert --dump-date --events --force --hex-blob --opt --add-drop-table --add-locks --create-options --disable-keys --extended-insert=1 --quick --set-charset --skip-lock-tables --order-by-primary --quote-names --single-transaction --tz-utc --verbose --result-file=dump.sql --databases sidi1234projeto9

-- MySQL dump 10.17  Distrib 10.3.22-MariaDB, for debian-linux-gnu (x86_64)
--
-- Host: localhost    Database: sidi1234projeto9
-- ------------------------------------------------------
...
--
-- Current Database: `sidi1234projeto9`
--

/*!40000 DROP DATABASE IF EXISTS `sidi1234projeto9`*/;

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `sidi1234projeto9` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;

USE `sidi1234projeto9`;
...
--
-- Dumping events for database 'sidi1234projeto9'
--
